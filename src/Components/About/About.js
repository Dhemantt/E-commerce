  ...
  return (
    <div className={style.about}>
      ...
      <div className={style.aboutText}>
        ...
        Him whom something large cisterns. Lorem ipsum carrots enhanced rebates.
        ...
        <p style={{marginTop: '50px'}}>
          ...
          this pain will be a right enjoyed by corrupt, are accusing him of all
          ...
          therefore, an obstacle to the duties of the debts receives the very
          great importance to us that these are consequent to that question is
